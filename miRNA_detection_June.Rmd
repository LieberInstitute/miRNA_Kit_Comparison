...
save(split_amt_thresh, file =here("Complete_data/one_batch_thresh10across_trip.rda"))
```
...
cols = gg_color_hue(n)
cols <-cols[1:5]
vp_alpha <- venn.diagram(miRNAs_1000ng[1:5], fill = c(cols), alpha = 0.5, filename = NULL, margin = 0.2, cat.dist = c(.3,.3,.3, .3, .3))
