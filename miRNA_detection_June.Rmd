...
library(compute.es)
tes(t = 5.2, n.1 = 18, n.2 = 9)
tes(t = 9.3, n.1 = 18, n.2 = 12)
tes(t = 5.2, n.1 = 18, n.2 = 18)
tes(t = 6.9, n.1 = 18, n.2 = 18)
tes(t = 3, n.1 = 18, n.2 = 18)

tes(t = 4.8, n.1 = 9, n.2 = 12)
tes(t = 1, n.1 = 9, n.2 = 18)
tes(t = 2.3, n.1 = 9, n.2 = 18)
tes(t = -1.2, n.1 = 9, n.2 = 18)

tes(t = -2.9, n.1 = 12, n.2 = 18)
tes(t = -2.2, n.1 = 12, n.2 = 18)
tes(t = -4.8, n.1 = 12, n.2 = 18)

tes(t = 0.91, n.1 = 18, n.2 = 18)
tes(t = -1.8, n.1 = 18, n.2 = 18)
tes(t = -2.9, n.1 = 18, n.2 = 18)
...
get_perc_diff <-function(data) {
  ...
  tested_kits<<-list()
  for(i in names(test_names)){
    percresults[[i]]<<-(abs(data[ which(names(data)==test_names[i][1,])]-data[ which(names(data)==test_names[i][2,])]))/ data[ which(names(data)==test_names[i][1,])]*100
...
anova(lm(across_det_1000$det_Data.det_across_thresh~across_det_1000$det_Data.kit))
anova_stats(anova(lm(across_det_1000$det_Data.det_across_thresh~across_det_1000$det_Data.kit)))
pdf(file =here("Figures/Raw_plots/miRNA_inconsistency.pdf"),width=10,height=6)
...
t.test(c(det_Data$Clontech), c(det_Data$Illumina))
...
pdf(file =here("Figures/Raw_plots/Fig.3.c.pdf"),width=6,height=6,onefile=FALSE)
grid.draw(vp_1000);
dev.off()
...
ffun <- filterfun(poverafun)
genefilt_fun<- function(x){genefilter(x, ffun)}
thresh<-lapply(split_kit_miRNAData, genefilt_fun)
