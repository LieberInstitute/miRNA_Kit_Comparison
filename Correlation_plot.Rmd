...
ggplot(df, aes(x = A, y = M)) + geom_point(size = 1.5, alpha = 1/5)+ stat_smooth(se = FALSE, method = "loess", color = "red3")+ ylim(c(-7,7))+ geom_hline(color = "blue3", yintercept = 0) + xlim(4,18)+theme(axis.text.x = element_text(size = 40), axis.text.y = element_text(size = 40), axis.title.x = element_text(size = 40), axis.title.y = element_text(size = 40))
dev.off()
x = data_1000ng[, 1]#clontech
y = data_1000ng[, 3]#NEB
M = x - y
...
ggplot(df, aes(x = A, y = M)) + geom_point(size = 1.5, alpha = 1/5)+ stat_smooth(se = FALSE, method = "loess", color = "red3")+ ylim(c(-7,7))+geom_hline(color = "blue3", yintercept = 0)+ xlim(4,18)+ theme(axis.text.x = element_text(size = 20), axis.text.y = element_text(size = 20), axis.title.x = element_text(size = 20), axis.title.y = element_text(size = 20))
dev.off()
x = data_1000ng[, 4]#NEXTflex
y = data_1000ng[, 6]#Fivepercent
M = x - y
