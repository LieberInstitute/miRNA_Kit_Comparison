...
ggplot(errorAll, aes(x = Starting_Amount, y = value))+ geom_jitter(aes(col = Method))+ geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) + facet_grid(.~Method)+  ggtitle(label = "Inconsistency Across Triplicates")+ 
...
ggplot(errorAll, aes(x = Method, y = value))+ geom_jitter(aes(col = Method))+ geom_boxplot(outlier.shape = NA, varwidth = TRUE, notch = TRUE) + facet_grid(Starting_Amount~.)+  ggtitle(label = "Inconsistency Across Triplicates")+ 
      theme(axis.title.x = element_text(size =0), 
            plot.title = element_text(size = 20, face = "bold"), 
            axis.text.x = element_text(size = 20, angle = 60, hjust = 1),
            axis.text.y = element_text(size = 20), 
