...
dev.off()
#ggplot(data = melt(errorplot), aes(x=TTTT, y = value, fill = variable)) + geom_boxplot()+facet_grid(~variable)+theme(legend.position="none")+ geom_line(data = errorplot, linetype =2, size =1, aes(x=det_Data.startingAmt, y=det_Data.det_across_thresh, group=det_Data.kit, colour=det_Data.kit))
