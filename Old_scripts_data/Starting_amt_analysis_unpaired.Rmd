...
ggpairs(log2(split_amt_thresh$starting_amt_100$NEXTflex_deduped+1))
...
ggpairs(log2(split_amt_thresh$starting_amt_250$NEXTflex_deduped+1))
...
ggpairs(log2(split_amt_thresh$starting_amt_500$NEXTflex_deduped+1))
...
plot1000  + theme(legend.position = "none") + labs(y = "Absolute error from the mean", title = "Within batch error across kits with 100ng Starting Amount")
```
