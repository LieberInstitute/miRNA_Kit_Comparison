...
dim(split_kit_thresh$Clontech)
dim(split_kit_thresh$Illumina)
dim(split_kit_thresh$NEB)
dim(split_kit_thresh$NEXTflex)
dim(split_kit_thresh$Deduped)
...
miRNA_det<-list("Clontech\n(N=480)" = Clontech, "Illumina\n(N=186)" = Illumina, "NEB\n(N=792)" = NEB, "NextFlex\n(N=747)" =NEXTflex, "Deduped\n(N=717)" = Deduped)
