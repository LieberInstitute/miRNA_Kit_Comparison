...
# det_Data$startingAmt<-factor(det_Data$startingAmt, levels =  c("100", "250", "500", "1000", "1500", "2000"))
# ggplot(det_Data, aes(x = startingAmt, y = det_indv_thresh, color = kit))+ geom_boxplot() +geom_jitter()+ facet_grid(.~kit) 
# 
# ggplot(det_Data, aes(x = startingAmt, y = det_indv_thresh
```
...
get_test_results(raw_1000, test_names = test_names, pairedvalue = FALSE)
ttestStats_across<-data.frame(lapply(tresults, get_ttestStats, tested_kits = tested_kits))
colnames(ttestStats_across)<-tested_kits
t(ttestStats_across) #lower t indicates lower error across triplicates
