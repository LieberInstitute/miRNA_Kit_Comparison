...
total_miRNA<-vapply(strsplit(as.character(report$NULL.All.miRNA.Reads...Filtered.miRNA.Reads),"/"),`[`, 1, FUN.VALUE=character(1))
...
dim(iso_RPM2)
Totalmatrix<-rep.row((Total/1000000), 3179382)#width of isoRPM2
