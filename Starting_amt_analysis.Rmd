...
library(RCurl)
library(rlist)
report_url<-"/Users/carriewright/Documents/miRNA seq Projects/miRNA_kit_comparison_project/DATA_ANALYSIS/Kit_comparison_project/report.html"
...
tables <- list.clean(report, fun = is.null, recursive = FALSE)
n.rows <- unlist(lapply(tables, function(t) dim(t)[1]))

library(rvest)
file<-read_html(report_url)
