...
length(rownames(as.data.frame(split_amt_thresh$starting_amt_1000[grep("NEB", names(split_amt_thresh$starting_amt_1000))])))

detect_fun(data = split_amt_thresh$starting_amt_100, kits = names(split_amt_thresh$starting_amt_100))
detected_amounts_kit <- detected_amounts
detected_amounts_kit

lapply(split_amt_thresh, detect_fun, kits = names(split_batch_thresh))
