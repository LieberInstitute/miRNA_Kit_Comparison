...
test_names <- data.frame(combn(names(split_errorAll), m= 2))
...
Clontech_Illumina <-CATplot(Clontech_ranks$Clontech.3, Illumina_ranks$Illumina, col = "red")
Clontech_NEB <-CATplot(Clontech_ranks$Clontech.3, NEB_ranks$NEB.3, col = "blue")
Clontech_NEXTflex <- CATplot(Clontech_ranks$Clontech.3, NEXTflex_ranks$NEXTflex.3, col = "blue")
Clontech_Deduped<-CATplot(Clontech_ranks$Clontech.3, Deduped_ranks$Deduped.3, col = "blue")
Clontech_Fivepercent <-CATplot(Clontech_ranks$Clontech.3, Fivepercent_ranks$Fivepercent.3, col = "blue")
#grid.arrange(Clontech_Illumina, Clontech_NEB,Clontech_NEXTflex, Clontech_Deduped, Clontech_Fivepercent, ncol=1)
```
