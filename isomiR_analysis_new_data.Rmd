...
summarized_Data <- data.frame(total_isomiRs_above10, total_isomiR_reads, total_miRNA=t(as.vector(total_miRNA)), report$NULL.Total.Input.Reads)
cor.test(x=summarized_Data$total_isomiRs_above10, y=summarized_Data$report.NULL.Total.Input.Reads)
```
