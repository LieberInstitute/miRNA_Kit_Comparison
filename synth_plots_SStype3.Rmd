...
get_perc_diff <-function(data) {
  ...
  tested_kits<<-list()
  for(i in names(test_names)){
    percresults[[i]]<<-(abs(colMeans(data)[ which(names(colMeans(data))==test_names[i][1,])]-colMeans(data)[ which(names(colMeans(data))==test_names[i][2,])])/ colMeans(data)[ which(names(colMeans(data))==test_names[i][1,])])*100
