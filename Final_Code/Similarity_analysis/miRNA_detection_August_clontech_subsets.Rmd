...
# Pheno <- Pheno[c(19:57),]
miR_counts<-read.table(here("Clontechsubsets_withothers/miR.Counts.csv"), header = TRUE, sep  = ",")
Pheno <- read.table(here("Clontechsubsets_withothers/Pheno"), header = TRUE)
miR_counts<-miR_counts[-1,]
miR_counts<-miR_counts[-1]

#miR_counts <- miR_counts[which(Pheno$Include== "Yes" &Pheno$Amount == "orignial" |Pheno$Amount =="10M")]
#Pheno<-Pheno[which(Pheno$Include== "Yes" &Pheno$Amount == "orignial" |Pheno$Amount =="10M"),]
#miR_counts <- miR_counts[which(Pheno$Include== "Yes" &Pheno$Amount == "orignial" |Pheno$Amount =="5M")]
#Pheno<-Pheno[which(Pheno$Include== "Yes" &Pheno$Amount == "orignial" |Pheno$Amount =="5M"),]
#miR_counts <- miR_counts[which(Pheno$Include== "Yes" &Pheno$Amount == "orignial" |Pheno$Amount =="1M")]
#Pheno<-Pheno[which(Pheno$Include== "Yes" &Pheno$Amount == "orignial" |Pheno$Amount =="1M"),]
#miR_counts <- miR_counts[which(Pheno$Amount == "orignial") ]
#Pheno<-Pheno[which(Pheno$Amount == "orignial"),]
...
t(data.frame(lapply(norm_miR_counts, get_thresh_number)))
