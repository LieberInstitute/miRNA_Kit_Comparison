...
ref_counts<-read.table(here::here("Complete_data/synthetic_isomiRanalysis/full/miR.Counts.csv"), header = TRUE, sep = ",")
rownames(ref_counts)<-ref_counts$miRNA
ref_counts<-ref_counts[2:963,]
Pheno <-data.frame(Methods = factor(ss(colnames(ref_counts), "_", 1)))
...
#Lorena isomirs
#     TAATTTTATGTATAAGCTAGT  the real sequence
#1    TAATTTTATGTATGAGCTGG  hsa-miR-590-3p snp add3p shift3p   #in our data too
#2  TCAACAGACATTAATTGGGCGC     hsa-miR-421           shift5p                  
#3  TCCATTACACTACTCTGCCTCT  hsa-miR-885-5p               snp                  
#4  TCCCTGAGACTCTAACTTGTGA hsa-miR-125b-5p               snp                  
#5 TGAAGTGATGTGTAACTGATCAG     hsa-miR-573           shift5p   #in our data too but with a C also...   two bases for us..one for them           
#6 TTTGGGACTAGCACATTTTTGCT   hsa-miR-96-5p snp
