...
alldata$Kit <- factor(alldata$Kit, levels =c("Clontech","Illumina","NEB","NEXTflex","Deduped"))
  ...
  plot1002 +labs(x = "Rank of miRNA error", y = "log2 Average Expression", title = "Average batch error across kits") + stat_smooth(method = lm) 
}
...
alldata$Kit <- factor(alldata$Kit, levels =c("Clontech","Illumina","NEB","NEXTflex","Deduped"))
  ...
  plot1002 +labs(x = "GC_Content", y = "log2 Average Expression", title = "Average batch error across kits") + stat_smooth(method = lm) 
